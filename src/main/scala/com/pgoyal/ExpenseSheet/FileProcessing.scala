...
//C:/opt/general/data
case class uploadFileSchema ( filePathName: String = "/Users/goyalpushkar/opt/general/data", fileType: String = "csv", var fileName: String = "Jaitu_Apr_2023.csv"
                             ,fileSchema: Reader = null
                             ,noOfColumns: Int = 7
                             ,rowsToSkip: Int = 1, fileData: InputStream = null //Reader
                             ,uploadedBy: String = "Pushkar Goyal"
                             ,excelFileName: String = "Jaitu_Apr_2023Expense Sheet - 2023-Jaitu"
